...
if [ ! -d /www/server/panel/BTPanel ];then
	...
	echo "5.9平滑升级到6.0的命令：curl https://download.ccspump.com/ltd/install/update_to_6.sh|bash"
	exit 0;
fi
...
wget -T 5 -O /tmp/panel.zip $btsb_Url/install/update/LinuxPanel-7.1.1_pj.zip
